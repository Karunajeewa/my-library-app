...
import {Button, Row, Col, InputGroup, FormControl, Container} from 'react-bootstrap';
...
const UpdateBook: React.FC<Props> = ({showForm, onClick}) => {

    const form = (
        <Container>
        <div className="mt-4 m-lg-3">
            <Row>
                <Col xs={8} className="form-title">Update Book</Col>
